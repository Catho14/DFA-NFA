...
public class DFA extends javax.swing.JFrame {
    ...
    char efinish='4';//Variable del estado final
...
//Reiniciar las variables al limpiar 
    void ReiniciarVar(){
        start='0';
        efinish='4';
        finish=false;
    ...
    private void initComponents() {
        ...
        getContentPane().add(verificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, -1, -1));
        ...
        getContentPane().add(limpiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, -1, -1));
        ...
        getContentPane().add(Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 390, -1, -1));
        ...
        getContentPane().add(salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 390, -1, -1));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication24/DFA.PNG"))); // NOI18N
        ...
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 190, 120, 20));

        jLabel9.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        jLabel9.setText("∑=  {0,1}");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 250, 100, 20));

        jLabel5.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        jLabel5.setText("Q=(q0,q1,q2,q3,q4)   ");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 220, 120, 20));

        jLabel7.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        jLabel7.setText("F={q4}");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 280, 100, 20));

        jLabel6.setFont(new java.awt.Font("Comic Sans MS", 0, 10)); // NOI18N
        jLabel6.setText("L={w|w contenga pares de 1’s y pares de 0’s}");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 310, 210, 20));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 620, 440));
